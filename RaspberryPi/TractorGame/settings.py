...
GAME_ICON = pg.image.load(os.path.join("TractorGame/assets/Icons", "game_icon.png"))
GAME_MUSIC = os.path.join("TractorGame/assets/Music", "game_music.wav")
...
MENU_TITLE_FONT = pg.font.Font(os.path.join("TractorGame/assets/Menu", "arcade_font.TTF"), MENU_TITLE_SIZE)
...
MENU_CHARACTER_SPRITE = pg.image.load(os.path.join("TractorGame/assets/Menu", "menu_character.png"))
MENU_CHARACTER_POS = (SCREEN_WIDTH // 2 - MENU_CHARACTER_SPRITE.get_width() // 2, SCREEN_HEIGHT // 2 - MENU_CHARACTER_SPRITE.get_height() // 8)

MENU_START_BUTTON_SPRITE = pg.image.load(os.path.join("TractorGame/assets/Menu", "start_button.png"))
MENU_START_BUTTON = button.Button(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 3, MENU_START_BUTTON_SPRITE)

MENU_MUSIC = os.path.join("TractorGame/assets/Music", "menu_music.wav")

# Background 

BACKGROUND_SPRITES = [pg.image.load(os.path.join("TractorGame/assets/Game", "game_background.jpg")),
                      pg.image.load(os.path.join("TractorGame/assets/Menu", "menu_background.jpg"))]

# Player

PLAYER_MOVING_SPRITES = [pg.image.load(os.path.join("TractorGame/assets/Player", "player_moving_1.png")), 
                        pg.image.load(os.path.join("TractorGame/assets/Player", "player_moving_2.png"))]
